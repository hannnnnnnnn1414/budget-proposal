        ...
        <div class="container-fluid">
            <div class="row my-4">
                                                ...
                                                @forelse ($groupedItems as $item)
                                                    <tr class="hover:bg-gray-50">
                                                        ...
                                                        <td class="border p-2"
                                                            ...
                                                            @php
                                                                $budgetCode = \App\Models\BudgetCode::where(
                                                                    'bdc_id',
                                                                    $item['bdc_id'],
                                                                )->first();
                                                                echo $budgetCode ? $budgetCode->budget_name : '-';
                                                            @endphp
                                                        </td>
                                                        <td class="border p-2"
                                            ...
                                            <form id="editMonthForm" method="POST" action="">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" id="edit_month_ledger_account"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="edit_month_cur_id" class="form-label">Mata Uang
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="edit_month_amount_display"
                                                            class="form-label">Jumlah (IDR)</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">Ledger Account <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" name="ledger_account"
                                                                id="ledger_account" class="form-control"
                                                                placeholder="Masukkan ledger account" required
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row mb-3">
                                                            <!-- Currency -->
                                                            <div class="col-md-6">
                                                                <label for="cur_id" class="form-label">Mata Uang
                                                                    <span class="text-danger">*</span></label>
                                                                <select name="cur_id" id="cur_id"
                                                                    class="form-select select" required>
                                                                    <option value="" data-nominal="1" selected>
                                                                        Rp</option>
                                                                    @foreach (\App\Models\Currency::orderBy('currency', 'asc')->get() as $currency)
                                                                        <option value="{{ $currency->cur_id }}"
                                                                            data-nominal="{{ $currency->nominal }}">
                ...
                `);
                        ...
                        @else
                            <!-- Tampilan untuk selain Kadept atau dept 6121 -->
                            <div class="card-body">
