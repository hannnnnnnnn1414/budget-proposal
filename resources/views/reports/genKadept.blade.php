...
$approval = \App\Models\Approval::where(
    ...
    ->where('approve_by', Auth::user()->npk)
                            ...
                            <div class="card-header bg-secondary text-white py-2 px-2">
                                ...
                                <!-- [MODIFIKASI] Ubah tag h5 menjadi h6 agar konsisten -->
                            </div>
                            <!-- Item Table -->
                            <div class="bg-white p-4 rounded shadow mb-4">
                                @php
                                    ...
                                    // [MODIFIKASI] Definisikan $monthLabels sebelum digunakan
                                    $monthLabels = [
                                        'January' => 'Jan',
                                        'February' => 'Feb',
                                        'March' => 'Mar',
                                    ...
                                    // [MODIFIKASI] Kelompokkan submissions berdasarkan item unik (itm_id dan description)
                                    $groupedItems = $submissions
                                        ...
                                        ->map(function ($group) use ($monthLabels) {
                                            ...
                                            return [
                                                ...
                                                'months' => $months,
                                                'total' => array_sum($months), // [MODIFIKASI] Hitung total price dari semua bulan
                                                'sub_id' => $first->sub_id,
                                                'id' => $first->id,
                                                'status' => $first->status,
                                            ];
