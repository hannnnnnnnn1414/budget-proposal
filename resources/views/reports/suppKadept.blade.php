                        ...
                        <form id="addItemForm" method="POST"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="unit" class="form-control" required>
                                            ...
                                            <option value="LOT" @selected(old('unit') == 'LOT')>LOT</option>
                                            <option value="PCS" @selected(old('unit') == 'PCS')>PCS</option>
                                            <option value="KG" @selected(old('unit') == 'KG')>KG</option>
                                            <option value="M" @selected(old('unit') == 'M')>M</option>
                                            <option value="CM" @selected(old('unit') == 'CM')>CM</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- Budget (R/NR) -->
                                    <div class="mb-3">
                                        <label for="lob_id" class="form-label">Line Of Business</label>
