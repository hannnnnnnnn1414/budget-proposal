                                    ...
                                    ->map(function ($group) use ($monthLabels) {
                                        ...
                                        foreach ($group as $submission) {
                                            if (array_key_exists($submission->month, $monthLabels)) {
                                                $monthsData[$submission->month] = $submission->price;
                                            }
                                        }
                                        return [
                                            'item' => $first->itm_id ?? '',
                                    ...
                                    @php
                                        ...
                                        $groupedItems = $submissions
                                            ...
                                            ->map(function ($group) use ($monthLabels) {
                                                ...
                                                return [
                                                    'item' => $first->itm_id ?? '', // [MODIFIKASI] Gunakan itm_id langsung
                                                    'description' => $first->description,
                                                    'price' => $first->price,
                                                    'amount' => $first->amount,
                                                    'workcenter' =>
                                                    ...
                                                    'budget' =>
                                                        $first->budget != null ? $first->budget->budget_name : '',
                                                    'months' => $months,
                                                    'total' => array_sum($months), // Total price dari semua bulan
                                                    'sub_id' => $first->sub_id,
                                                    'id' => $first->id,
                                                    'status' => $first->status,
                                                ];
                                            ...
                                            <tbody>
                                                @forelse ($groupedItems as $item)
                                                    <tr class="hover:bg-gray-50">
                                                        ...
                                                        @endforeach
                                                        <td class="border p-2 text-center">Rp
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.open-edit-modal', function(e) {
                    ...
                    // [MODIFIKASI] Load modal content via AJAX
