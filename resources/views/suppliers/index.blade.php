    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-end mb-3">
                <a href="#" class="btn btn-danger" title="Create New Entry"
                    onclick="showCreateModal('{{ route('suppliers.create') }}')">
            ...
            <div class="row">
                ...
                <div class="card rounded-0">
                    <div class="mt-4">
                        <label class="form-label">Suppliers name or ID search</label>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <button class="btn-warning"
                                                        onclick="showEditModal('{{ route('suppliers.edit', $supplier->id) }}')"
                                                        title="Update">
                                                        <i class="fa-solid fa-edit"></i>
                                                    </button>
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input status-switch" type="checkbox" title="Active/Disabled"
                                                            data-id="{{ $supplier->id }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title text-white" id="createModalLabel">Add New Suppliers</h5>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-danger text-white">
                        <h5 class="modal-title text-white" id="editModalLabel">Edit Supplier</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
...
.catch(error => {
    ...
    // General validation errors
        ...
        for (const [field, messages] of Object.entries(error.errors)) {
            const label = fieldLabels[field] || field;
            errorMessages += `<strong>${label}:</strong> ${messages.join('<br>')}<br>`;
        }
    ...
    // Other errors
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: error.message || 'An error occurred while creating data',
            showConfirmButton: true,
            confirmButtonText: 'OK'
        });
    }
                    ...
                    .catch(error => {
                        ...
                        // Other errors
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
                                text: error.message || 'An error occurred while updating data',
                                showConfirmButton: true,
                                confirmButtonText: 'OK'
                            });
                        }
                        ...
                        fetch(`/suppliers/status/${id}`, {
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    showSuccessMessage(`Supplier has been ${actionText} successfully!`);
                                } else {
                                    this.checked = !isChecked;
                                    showErrorMessage(data.message || `Failed to ${action} supplier`);
                                }
                            })
                            .catch(error => {
                                console.error('Error:', error);
                                this.checked = !isChecked;
                                showErrorMessage(`An error occurred while trying to ${action} supplier`);
                            });
                    } else {
