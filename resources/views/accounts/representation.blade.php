                                                ...
                                                @if (session('temp_data'))
                                                    @foreach (session('temp_data') as $index => $data)
                                                        <tr>
                                                            <td>{{ $index + 1 }}</td>
                                                            <td>{{ $data['itm_id'] }}</td>
                                                            <!-- [MODIFIKASI] Gunakan itm_id langsung seperti di ads.blade -->
                                                            ...
                                                            <td class="text-end">
                                                                <!-- [MODIFIKASI] Gunakan amount langsung tanpa perhitungan quantity -->
                ...
                <div class="modal-content">
                    ...
                    <form id="itemForm" method="POST" action="{{ route('accounts.addTempData') }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <!-- [MODIFIKASI] Ganti input_type dan select itm_id/manual_item dengan input text itm_id seperti di ads.blade -->
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Beneficiary</label><span
                                            class="text-danger">*</span>
                                        <textarea class="form-control" name="beneficiary" id="beneficiary" placeholder="Beneficiary" required>{{ old('beneficiary') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <!-- [MODIFIKASI] Tambah hidden input untuk amount seperti di ads.blade -->
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#itemModal').on('shown.bs.modal', function() {
                    ...
                    // [MODIFIKASI] Ubah tinggi Select2 agar sama seperti input seperti di ads.blade
                    ...
                    // [MODIFIKASI] Load currencies via AJAX seperti di ads.blade
                    $.ajax({
                ...
                // [MODIFIKASI] Handle currency change untuk menampilkan info konversi seperti di ads.blade
                ...
                // [MODIFIKASI] Tambah event untuk memastikan itm_id diubah ke uppercase seperti di ads.blade
                $('#itm_id').on('input', function() {
                    $(this).val($(this).val().toUpperCase());
                });
                // [MODIFIKASI] Hitung amount berdasarkan price dan nominal currency (quantity dihapus) seperti di ads.blade
                ...
                // [MODIFIKASI] Handle form submission untuk menambahkan hidden input amount seperti di ads.blade
