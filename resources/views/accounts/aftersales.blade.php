                                    ...
                                    <table class="table table-bordered" id="itemsTable">
                                        <thead>
                                            <tr>
                                                <th width="5%">No.</th>
                                                <th>Item</th>
                                                <th>Customer</th> <!-- [MODIFIKASI] Pertahankan Customer -->
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="8" class="text-center text-muted">No items added yet
                                                    </td>
                    ...
                    <form id="itemForm" method="POST" action="{{ route('accounts.addTempData') }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Item Claim</label><span class="text-danger">*</span>
                                        <input type="text" name="itm_id" id="itm_id" class="form-control"
                                            placeholder="Enter item claim name" required value="{{ old('itm_id') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="customer" id="customer" placeholder="Customer" required>{{ old('customer') }}</textarea> <!-- [MODIFIKASI] Pertahankan Customer -->
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row mb-3">
