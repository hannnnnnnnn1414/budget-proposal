                                        ...
                                        <table class="table table-bordered" id="itemsTable">
                                            <thead>
                                                <tr>
                                                    <th width="5%">No.</th>
                                                    <th>Trip Propose</th>
                                                    <!-- [MODIFIKASI] Tambah kolom Trip Propose -->
                                                    <th>Destination</th> <!-- [MODIFIKASI] Tambah kolom Destination -->
                                                    <th>Days</th>
                                                    <th>Price</th> <!-- [MODIFIKASI] Ubah lebar kolom dihapus -->
                                                    <th>Amount</th> <!-- [MODIFIKASI] Ubah lebar kolom dihapus -->
                                                    <th>Workcenter</th>
                                                    <th>Department</th>
                                                    <th>Month</th>
                                                    <th width="10%">Action</th>
                                                    <!-- [MODIFIKASI] Kolom Action tetap -->
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if (session('temp_data'))
                                                    @foreach (session('temp_data') as $index => $data)
                                                        <tr>
                                                            <td>{{ $index + 1 }}</td>
                                                            <td>{{ $data['trip_propose'] ?? '-' }}</td>
                                                            <!-- [MODIFIKASI] Ganti itm_id dengan trip_propose -->
                                                            ...
                                                            <td>
                                                                <!-- [MODIFIKASI] Tampilkan nama bulan langsung dalam bahasa Inggris -->
                                                                {{ $data['month'] ?? '-' }}
                                                            </td>
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="9" class="text-center text-muted">Belum ada item
                                                            ditambahkan
                                                        </td> <!-- [MODIFIKASI] Ubah colspan sesuai jumlah kolom -->
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content text-center p-4" style="border-radius: 15px;">
                                                ...
                                                <p class="mb-4">Apakah Anda yakin ingin membatalkan
                                                    pengajuan?<br>Semua
                                                    data yang dimasukkan akan hilang.</p>
                    ...
                    <form id="itemForm" method="POST" action="{{ route('accounts.addTempData') }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Trip Propose</label><span
                                            class="text-danger">*</span>
                                        <!-- [MODIFIKASI] Ganti Item Type dengan Trip Propose -->
                                        <input type="text" name="trip_propose" id="trip_propose"
                                            class="form-control" placeholder="Masukkan tujuan perjalanan" required>
                                        <!-- [MODIFIKASI] Ganti select item dengan input trip_propose -->
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Destination</label><span
                                            class="text-danger">*</span>
                                        <!-- [MODIFIKASI] Ganti Description dengan Destination -->
                                        <input type="text" name="destination" id="destination"
                                            class="form-control" placeholder="Masukkan destinasi" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Hari</label><span class="text-danger">*</span>
                                        <input type="number" class="form-control" name="days" id="days"
                                            value="{{ old('days') }}" placeholder="Hari" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <!-- [MODIFIKASI] Ganti label Bulan menjadi Month dan gunakan nama bulan dalam bahasa Inggris -->
                                        <select class="form-control" name="month" id="month" required>
                                            <option value="">-- Select Month --</option>
                                            <!-- [MODIFIKASI] Ubah placeholder untuk konsistensi bahasa Inggris -->
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#price, #cur_id').on('input', function() {
                    ...
                    const currency = currencies.find(c => c.cur_id === cur_id);
                    const nominal = currency ? parseFloat(currency.nominal) : 1;
                    const amount = price * nominal; // [MODIFIKASI] Hapus perhitungan quantity
