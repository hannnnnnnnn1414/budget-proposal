    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg">
                                                ...
                                                @if (session('temp_data'))
                                                    @foreach (session('temp_data') as $index => $data)
                                                        <tr>
                                                            <td>{{ $index + 1 }}</td>
                                                            <td>{{ $data['itm_id'] ?? '-' }}</td>
                                                            <!-- [MODIFIKASI] Gunakan itm_id untuk kolom Item -->
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="7" class="text-center text-muted">No items added
                                                            yet</td>
                                                        <!-- [MODIFIKASI] Tetap colspan 7 karena struktur tabel tidak berubah -->
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <!-- [MODIFIKASI] Gunakan itm_id untuk input Item -->
                                    </div>
                                    <div class="mb-3">
        ...
        <script>
            $(document).ready(function() {
                ...
                // [MODIFIKASI] Tambah event untuk memastikan itm_id diubah ke uppercase (opsional, sesuai kebutuhan)
                $('#itm_id').on('input', function() {
                    $(this).val($(this).val().toUpperCase());
                });

                // [MODIFIKASI] Hapus fungsi toggle input_type dan fetch item name karena Item Type dan Item GID/Non-GID dihapus
