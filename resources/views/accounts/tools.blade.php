                                    ...
                                    <table class="table table-bordered" id="itemsTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <!-- [MODIFIKASI] Perbaiki typo "Ampunt" menjadi "Amount" -->
                                                <th>Workcenter</th>
                                                <th>Department</th>
                                                <th>Month</th>
                                                <th>R/NR</th>
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                ...
                                                <tr>
                                                    <td colspan="9" class="text-center text-muted">No items added yet
                                                    </td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="cur_id" id="cur_id" class="form-select select"
                                                required> <!-- [MODIFIKASI] Tambahkan class select -->
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="wct_id" class="form-control select" required id="wct_id">
                                            <!-- [MODIFIKASI] Tambahkan class select -->
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#itemModal').on('shown.bs.modal', function() {
                    // [MODIFIKASI] Inisialisasi Select2 untuk semua elemen dengan class select
                    $('.select').select2({
                    ...
                    // [MODIFIKASI] Hapus inisialisasi Select2 spesifik untuk itm_id dan cur_id
                    // $('#itm_id').select2({
                    //     dropdownParent: $('#itemModal'),
                    //     allowClear: true,
                ...
                // [MODIFIKASI] Hapus fetch item name karena field Item GID dihapus
                ...
                // [MODIFIKASI] Calculate amount tanpa quantity
                ...
                // [MODIFIKASI] Hapus toggle input type karena field Item Type dihapus
                ...
                // [MODIFIKASI] Handle form submission tanpa quantity
