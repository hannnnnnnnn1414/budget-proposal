                                    ...
                                    <table class="table table-bordered" id="itemsTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <!-- [MODIFIKASI] Koreksi typo 'Ampunt' menjadi 'Amount' -->
                                                <th>Workcenter</th>
                                                <th>Department</th>
                                                <th>Month</th>
                                                <th>R/NR</th>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#itemModal').on('shown.bs.modal', function() {
                    ...
                    // [MODIFIKASI] Hapus inisialisasi Select2 spesifik untuk itm_id dan cur_id karena sudah ditangani di atas
                    // $('#itm_id').select2({
                    //     dropdownParent: $('#itemModal'),
                    //     allowClear: true,
                ...
                $('#cur_id').on('change', function() {
                    ...
                    // [MODIFIKASI] Trigger input price saja karena quantity dihapus
                    $('#price').trigger('input');
                });

                // [MODIFIKASI] Hapus logika toggle input_type karena Item Type, Item GID, dan Item Non-GID dihapus
                ...
                // [MODIFIKASI] Hapus logika pengambilan item name karena Item GID dihapus
                ...
                // Calculate amount
                // [MODIFIKASI] Perhitungan amount hanya berdasarkan price dan nominal karena quantity dihapus
