                                        ...
                                        <table class="table table-bordered" id="itemsTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Department</th>
                                                    <th>Month</th>
                                                    <th>Position</th> <!-- [MODIFIKASI] Tambah kolom Position -->
                                                ...
                                                @if (session('temp_data'))
                                                    @foreach (session('temp_data') as $index => $data)
                                                        <tr>
                                                            ...
                                                            <td>{{ $data['month'] ?? '-' }}</td>
                                                            <td>{{ $data['position'] ?? '-' }}</td>
                                                            <!-- [MODIFIKASI] Tampilkan data Position -->
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="9" class="text-center text-muted">No items added
                                                            yet</td>
                                                        <!-- [MODIFIKASI] Ubah colspan ke 9 karena Qty dan R/NR dihapus, Position ditambah -->
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="position" id="position" class="form-control"
                                            placeholder="Enter position" required value="{{ old('position') }}">
                                        <!-- [MODIFIKASI] Tambah input field Position -->
                                    </div>
                                </div>
