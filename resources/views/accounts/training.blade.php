                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="8" class="text-center text-muted">No items added
                                                            yet
                                                        </td> <!-- [MODIFIKASI] Ubah colspan dari 9 ke 8 -->
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="participant"
                                            id="participant" value="{{ old('participant') }}"
                                            placeholder="Participant">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Jenis Training</label><span
                                            class="text-danger">*</span>
                                        <input type="text" step="0.01" class="form-control"
                                            name="jenis_training" id="jenis_training"
                                            value="{{ old('jenis_training') }}" placeholder="Jenis Training"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
