            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Insurance Company</label><span class="text-danger">*</span>
                            <select name="ins_id" class="form-control" required id="ins_id">
                                <option value="">-- Select Item --</option>
                                @foreach ($insurances as $insID => $company)
                                    <option value="{{ $insID }}" @selected(old('ins_id') == $insID || $submission->ins_id == $insID)>
                                        {{ $company }}
                                    </option>
                                @endforeach
                            </select>
