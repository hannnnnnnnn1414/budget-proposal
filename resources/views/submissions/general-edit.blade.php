                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" required id="quantity" name="quantity"
                                value="{{ old('quantity', $submission->quantity ?? 0) }}" placeholder="Quantity"
                                step="1" min="0">
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="dpt_id" value="{{ old('dpt_id', $submission->dpt_id) }}">
                            <input class="form-control" value="{{ $submission->dept->department ?? '-' }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label">Workcenter</label>
                            <select name="wct_id" class="form-control select" id="wct_id">
                                <option value="">-- Select Workcenter --</option>
                                @foreach ($workcenters as $wctID => $workcenter)
                                    <option value="{{ $wctID }}"
                                        {{ old('wct_id', $submission->wct_id) == $wctID ? 'selected' : '' }}>
                                        {{ $workcenter }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="month" class="form-control" required>
                                ...
                                @foreach (['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'] as $month)
                                    <option value="{{ $month }}"
                                        {{ old('month', $submission->month) == $month ? 'selected' : '' }}>
                                        {{ $month }}
                                    </option>
                                @endforeach
                            </select>
